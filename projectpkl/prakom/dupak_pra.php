<?php
    ...
    $exe      =mysqli_query($conn, "SELECT * FROM halaman WHERE nama_halaman = 'DUPAK'");
...
?>
<button type="button"><a href="./dupak_baru.php">DUPAK Baru</a></button>
<h2>DAFTAR DUPAK PRANATA KOMPUTER</h2>
...
<td align="center">
<a href="dupak_ubah.php?id=<?php echo $list['id_user'];

?>">Ubah</a> |

<a href="user_delete.php?id=<?php echo $list["id_user"]; ?>"

onclick="return KonfirmasiHapus()" >Hapus</a></td>
</tbody>
<?php
}
?>
